...
AdmissionsConfig.java - Initialises "meta-variables" S, T, and W. 
...
After you coded up your strategy, test it out by editing students.txt. List all the strategies you want to run, then call "make test". Note you can have multiple copies of the same strategy. Results are printed on screen as well as saved in "results.csv".
